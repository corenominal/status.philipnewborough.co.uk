...
This site uses Bootstrap 5, which is a popular CSS framework. The code style for this project follows the BEM (Block Element Modifier) naming convention for CSS classes, which helps to keep the code organized and maintainable. Use of utility classes from Bootstrap is encouraged for common styling needs, while custom styles should be defined in separate CSS files.
